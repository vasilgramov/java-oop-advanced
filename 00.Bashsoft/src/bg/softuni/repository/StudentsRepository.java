...
public class StudentsRepository implements Request {
    ...
    @Override
    public SimpleOrderedBag<Course> getAllCoursedSorted(Comparator<Course> cmp) {
        SimpleOrderedBag<Course> simpleOrderedBag = new SimpleSortedList<Course>(Course.class, cmp);
        simpleOrderedBag.addAll(this.courses.values());

        return simpleOrderedBag;
    }

    @Override
    public SimpleOrderedBag<Student> getAllStudentsSorted(Comparator<Student> cmp) {
        SimpleOrderedBag<Student> simpleOrderedBag = new SimpleSortedList<Student>(Student.class, cmp);
        simpleOrderedBag.addAll(this.students.values());
